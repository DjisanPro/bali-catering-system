    ...
    <div className="space-y-6 max-w-5xl">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-2xs space-y-4">
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div className="flex items-center gap-2">
            <Award className="w-5 h-5 text-[#E86319]" />
            <h3 className="font-bold text-sm text-slate-900 font-heading">
              Identidade Visual Oficial (Bali Catering Service)
            </h3>
          </div>
          <span className="px-2.5 py-0.5 rounded-full bg-orange-50 text-[#E86319] text-[11px] font-bold border border-orange-200">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-2xs space-y-6 text-xs">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-4 border-b border-slate-200 gap-4">
          <div>
            <h3 className="font-bold text-sm text-slate-900 flex items-center gap-2 font-heading">
              <Database className="w-5 h-5 text-[#E86319]" />
        ...
        <div className="p-4 rounded-xl bg-orange-50/40 border border-orange-200 space-y-3">
          <div className="flex items-center gap-2">
            <Sparkles className="w-4 h-4 text-[#E86319]" />
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3">
            ...
            <button
              ...
              className="w-full sm:w-auto px-5 py-2 rounded-xl bg-[#E86319] hover:bg-orange-600 text-white font-bold flex items-center justify-center gap-2 transition-colors shadow-xs cursor-pointer disabled:opacity-50"
            >
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 pt-2">
          <div className="flex flex-wrap gap-3">
            ...
            >
              <Download className="w-4 h-4 text-[#E86319]" />
                ...
                >
                  <div className="space-y-1.5">
                    ...
                    <div className="flex items-center gap-2 text-[10px] text-slate-600 font-medium">
                                          <span className="px-1.5 py-0.5 bg-slate-100 rounded">
                                            {point.itemCounts?.products ?? 0} produtos
                                          </span>
                                          <span className="px-1.5 py-0.5 bg-slate-100 rounded">
                                            {point.itemCounts?.ingredients ?? 0} insumos
                                          </span>
                                          <span className="px-1.5 py-0.5 bg-slate-100 rounded">
                                            {point.itemCounts?.orders ?? 0} pedidos
                                          </span>
                                          <span className="px-1.5 py-0.5 bg-slate-100 rounded">
                                            {point.itemCounts?.payments ?? 0} pagamentos
                                          </span>
                                          <span className="px-1.5 py-0.5 bg-slate-100 rounded">
                                            {point.itemCounts?.customers ?? 0} clientes
                                          </span>
                                        </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <button
                      ...
                      className="px-3.5 py-2 rounded-xl bg-orange-50 hover:bg-[#E86319] text-[#E86319] hover:text-white font-bold text-xs border border-orange-200 hover:border-transparent flex items-center gap-1.5 transition-colors cursor-pointer"
                    >
          ...
          <div className="bg-white rounded-2xl p-6 max-w-md w-full border border-slate-200 shadow-xl space-y-4 text-xs animate-in fade-in zoom-in-95">
            ...
            <div className="flex justify-end gap-3 pt-2">
              ...
              <button
                ...
                disabled={isRestoring}
                className="px-5 py-2.5 rounded-xl bg-[#E86319] hover:bg-orange-600 text-white font-bold flex items-center gap-2 transition-colors shadow-xs cursor-pointer disabled:opacity-50"
              >
      ...
      <form onSubmit={handleSave} className="bg-white rounded-2xl border border-slate-200 p-6 shadow-2xs space-y-6 text-xs">
        <div className="flex items-center justify-between pb-4 border-b border-slate-200">
          <div>
            <h3 className="font-bold text-sm text-slate-900 flex items-center gap-2 font-heading">
              <Settings className="w-4 h-4 text-[#E86319]" />
          ...
          <button
            type="submit"
            className="px-5 py-2.5 rounded-xl bg-[#E86319] hover:bg-orange-600 text-white font-bold text-xs shadow-xs flex items-center gap-2 transition-colors cursor-pointer"
          >
            <Save className="w-4 h-4" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 rounded-xl border border-slate-200 font-bold text-[#E86319] focus:ring-2 focus:ring-orange-500 focus:outline-none"
            />
          </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-2xs space-y-4 text-xs">
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div className="flex items-center gap-2">
            <Lock className="w-4 h-4 text-[#E86319]" />
            <h3 className="font-bold text-sm text-slate-900 font-heading">
        ...
        <form onSubmit={handlePinChangeSubmit} className="space-y-4 pt-2">
          ...
          <div className="flex justify-end pt-1">
            ...
            >
              <KeyRound className="w-4 h-4 text-[#E86319]" />
