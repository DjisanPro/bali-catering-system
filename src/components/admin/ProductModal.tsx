      ...
      <div className="bg-white rounded-3xl max-w-3xl w-full shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 flex flex-col max-h-[92vh] border border-slate-200">
        ...
        <div className="p-5 border-b border-slate-200 flex items-center justify-between bg-gradient-to-r from-slate-50 to-orange-50/40">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-orange-100 text-[#F27D26] border border-orange-200 flex items-center justify-center font-bold">
        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-6 text-xs flex-1 scrollbar-thin">
          ...
          <div className="space-y-4">
            <h4 className="font-heading font-bold text-xs uppercase tracking-wider text-[#F27D26] flex items-center gap-1.5 border-b border-slate-100 pb-1.5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="350"
                    className="w-full pl-10 pr-3 py-2.5 rounded-xl border border-slate-200 font-bold text-sm text-[#F27D26] focus:ring-2 focus:ring-orange-500 focus:outline-none"
                  />
                </div>
              </div>
          ...
          <div className="space-y-3 pt-2">
            <div className="flex items-center justify-between border-b border-slate-100 pb-1.5">
              <h4 className="font-heading font-bold text-xs uppercase tracking-wider text-[#F27D26] flex items-center gap-1.5">
                        ...
                        return (
                          <div
                            ...
                            className={`relative rounded-lg overflow-hidden border-2 cursor-pointer group h-16 transition-all ${
                              isSelected
                                ? 'border-[#F27D26] ring-2 ring-orange-200 scale-95'
          ...
          <div className="pt-4 border-t border-slate-200 flex justify-end gap-3 sticky bottom-0 bg-white/95 backdrop-blur-xs py-2">
            ...
            <button
              type="submit"
              className="px-6 py-2.5 rounded-xl bg-[#F27D26] hover:bg-orange-600 text-white font-bold shadow-md hover:shadow-orange-500/20 transition-all cursor-pointer flex items-center gap-2"
            >
